...
class Dimproductsubcategory(models.Model):
    ...
    englishproductsubcategoryname = models.CharField(db_column='EnglishProductSubcategoryName', max_length=50, db_collation='SQL_Latin1_General_CP1_CI_AS')  # Field name made lowercase.
    spanishproductsubcategoryname = models.CharField(db_column='SpanishProductSubcategoryName', max_length=50, db_collation='SQL_Latin1_General_CP1_CI_AS')  # Field name made lowercase.
    frenchproductsubcategoryname = models.CharField(db_column='FrenchProductSubcategoryName', max_length=50, db_collation='SQL_Latin1_General_CP1_CI_AS')  # Field name made lowercase.
...
class Dimpromotion(models.Model):
    ...
    englishpromotionname = models.CharField(db_column='EnglishPromotionName', max_length=255, db_collation='SQL_Latin1_General_CP1_CI_AS', blank=True, null=True)  # Field name made lowercase.
    spanishpromotionname = models.CharField(db_column='SpanishPromotionName', max_length=255, db_collation='SQL_Latin1_General_CP1_CI_AS', blank=True, null=True)  # Field name made lowercase.
    frenchpromotionname = models.CharField(db_column='FrenchPromotionName', max_length=255, db_collation='SQL_Latin1_General_CP1_CI_AS', blank=True, null=True)  # Field name made lowercase.
    discountpct = models.FloatField(db_column='DiscountPct', blank=True, null=True)  # Field name made lowercase.
    englishpromotiontype = models.CharField(db_column='EnglishPromotionType', max_length=50, db_collation='SQL_Latin1_General_CP1_CI_AS', blank=True, null=True)  # Field name made lowercase.
    spanishpromotiontype = models.CharField(db_column='SpanishPromotionType', max_length=50, db_collation='SQL_Latin1_General_CP1_CI_AS', blank=True, null=True)  # Field name made lowercase.
    frenchpromotiontype = models.CharField(db_column='FrenchPromotionType', max_length=50, db_collation='SQL_Latin1_General_CP1_CI_AS', blank=True, null=True)  # Field name made lowercase.
    englishpromotioncategory = models.CharField(db_column='EnglishPromotionCategory', max_length=50, db_collation='SQL_Latin1_General_CP1_CI_AS', blank=True, null=True)  # Field name made lowercase.
    spanishpromotioncategory = models.CharField(db_column='SpanishPromotionCategory', max_length=50, db_collation='SQL_Latin1_General_CP1_CI_AS', blank=True, null=True)  # Field name made lowercase.
    frenchpromotioncategory = models.CharField(db_column='FrenchPromotionCategory', max_length=50, db_collation='SQL_Latin1_General_CP1_CI_AS', blank=True, null=True)  # Field name made lowercase.
...
class Dimreseller(models.Model):
    ...
    geographykey = models.ForeignKey(Dimgeography, models.DO_NOTHING, db_column='GeographyKey', blank=True, null=True)  # Field name made lowercase.
    reselleralternatekey = models.CharField(db_column='ResellerAlternateKey', unique=True, max_length=15, db_collation='SQL_Latin1_General_CP1_CI_AS', blank=True, null=True)  # Field name made lowercase.
    phone = models.CharField(db_column='Phone', max_length=25, db_collation='SQL_Latin1_General_CP1_CI_AS', blank=True, null=True)  # Field name made lowercase.
    businesstype = models.CharField(db_column='BusinessType', max_length=20, db_collation='SQL_Latin1_General_CP1_CI_AS')  # Field name made lowercase.
    resellername = models.CharField(db_column='ResellerName', max_length=50, db_collation='SQL_Latin1_General_CP1_CI_AS')  # Field name made lowercase.
    numberemployees = models.IntegerField(db_column='NumberEmployees', blank=True, null=True)  # Field name made lowercase.
    orderfrequency = models.CharField(db_column='OrderFrequency', max_length=1, db_collation='SQL_Latin1_General_CP1_CI_AS', blank=True, null=True)  # Field name made lowercase.
    ...
    productline = models.CharField(db_column='ProductLine', max_length=50, db_collation='SQL_Latin1_General_CP1_CI_AS', blank=True, null=True)  # Field name made lowercase.
    addressline1 = models.CharField(db_column='AddressLine1', max_length=60, db_collation='SQL_Latin1_General_CP1_CI_AS', blank=True, null=True)  # Field name made lowercase.
    addressline2 = models.CharField(db_column='AddressLine2', max_length=60, db_collation='SQL_Latin1_General_CP1_CI_AS', blank=True, null=True)  # Field name made lowercase.
...
class Dimsalesreason(models.Model):
    ...
    salesreasonname = models.CharField(db_column='SalesReasonName', max_length=50, db_collation='SQL_Latin1_General_CP1_CI_AS')  # Field name made lowercase.
    salesreasonreasontype = models.CharField(db_column='SalesReasonReasonType', max_length=50, db_collation='SQL_Latin1_General_CP1_CI_AS')  # Field name made lowercase.
...
class Dimsalesterritory(models.Model):
    ...
    salesterritoryregion = models.CharField(db_column='SalesTerritoryRegion', max_length=50, db_collation='SQL_Latin1_General_CP1_CI_AS')  # Field name made lowercase.
    salesterritorycountry = models.CharField(db_column='SalesTerritoryCountry', max_length=50, db_collation='SQL_Latin1_General_CP1_CI_AS')  # Field name made lowercase.
    salesterritorygroup = models.CharField(db_column='SalesTerritoryGroup', max_length=50, db_collation='SQL_Latin1_General_CP1_CI_AS', blank=True, null=True)  # Field name made lowercase.
...
class Dimscenario(models.Model):
    ...
    scenarioname = models.CharField(db_column='ScenarioName', max_length=50, db_collation='SQL_Latin1_General_CP1_CI_AS', blank=True, null=True)  # Field name made lowercase.
...
class Factadditionalinternationalproductdescription(models.Model):
    productkey = models.IntegerField(db_column='ProductKey', primary_key=True)  # Field name made lowercase. The composite primary key (ProductKey, CultureName) found, that is not supported. The first column is selected.
    culturename = models.CharField(db_column='CultureName', max_length=50, db_collation='SQL_Latin1_General_CP1_CI_AS')  # Field name made lowercase.
    productdescription = models.TextField(db_column='ProductDescription', db_collation='SQL_Latin1_General_CP1_CI_AS')  # Field name made lowercase.
...
class Factcallcenter(models.Model):
    ...
    wagetype = models.CharField(db_column='WageType', max_length=15, db_collation='SQL_Latin1_General_CP1_CI_AS')  # Field name made lowercase.
    shift = models.CharField(db_column='Shift', max_length=20, db_collation='SQL_Latin1_General_CP1_CI_AS')  # Field name made lowercase.
...
class Factcurrencyrate(models.Model):
    currencykey = models.OneToOneField(Dimcurrency, models.DO_NOTHING, db_column='CurrencyKey', primary_key=True)  # Field name made lowercase. The composite primary key (CurrencyKey, DateKey) found, that is not supported. The first column is selected.
    datekey = models.ForeignKey(Dimdate, models.DO_NOTHING, db_column='DateKey')  # Field name made lowercase.
...
class Factinternetsales(models.Model):
    ...
    duedatekey = models.ForeignKey(Dimdate, models.DO_NOTHING, db_column='DueDateKey', related_name='factinternetsales_duedatekey_set')  # Field name made lowercase.
    shipdatekey = models.ForeignKey(Dimdate, models.DO_NOTHING, db_column='ShipDateKey', related_name='factinternetsales_shipdatekey_set')  # Field name made lowercase.
    ...
    salesordernumber = models.CharField(db_column='SalesOrderNumber', primary_key=True, max_length=20, db_collation='SQL_Latin1_General_CP1_CI_AS')  # Field name made lowercase. The composite primary key (SalesOrderNumber, SalesOrderLineNumber) found, that is not supported. The first column is selected.
    ...
    carriertrackingnumber = models.CharField(db_column='CarrierTrackingNumber', max_length=25, db_collation='SQL_Latin1_General_CP1_CI_AS', blank=True, null=True)  # Field name made lowercase.
    customerponumber = models.CharField(db_column='CustomerPONumber', max_length=25, db_collation='SQL_Latin1_General_CP1_CI_AS', blank=True, null=True)  # Field name made lowercase.
...
class Factinternetsalesreason(models.Model):
    salesordernumber = models.OneToOneField(Factinternetsales, models.DO_NOTHING, db_column='SalesOrderNumber', primary_key=True)  # Field name made lowercase. The composite primary key (SalesOrderNumber, SalesOrderLineNumber, SalesReasonKey) found, that is not supported. The first column is selected.
    salesorderlinenumber = models.ForeignKey(Factinternetsales, models.DO_NOTHING, db_column='SalesOrderLineNumber', related_name='factinternetsalesreason_salesorderlinenumber_set')  # Field name made lowercase.
...
class Factproductinventory(models.Model):
    productkey = models.OneToOneField(Dimproduct, models.DO_NOTHING, db_column='ProductKey', primary_key=True)  # Field name made lowercase. The composite primary key (ProductKey, DateKey) found, that is not supported. The first column is selected.
    datekey = models.ForeignKey(Dimdate, models.DO_NOTHING, db_column='DateKey')  # Field name made lowercase.
...
class Factresellersales(models.Model):
    productkey = models.ForeignKey(Dimproduct, models.DO_NOTHING, db_column='ProductKey')  # Field name made lowercase.
    orderdatekey = models.ForeignKey(Dimdate, models.DO_NOTHING, db_column='OrderDateKey')  # Field name made lowercase.
    duedatekey = models.ForeignKey(Dimdate, models.DO_NOTHING, db_column='DueDateKey', related_name='factresellersales_duedatekey_set')  # Field name made lowercase.
    shipdatekey = models.ForeignKey(Dimdate, models.DO_NOTHING, db_column='ShipDateKey', related_name='factresellersales_shipdatekey_set')  # Field name made lowercase.
...
class Newfactcurrencyrate(models.Model):
    ...
    currencyid = models.CharField(db_column='CurrencyID', max_length=3, db_collation='SQL_Latin1_General_CP1_CI_AS', blank=True, null=True)  # Field name made lowercase.
...
class Prospectivebuyer(models.Model):
    ...
    prospectalternatekey = models.CharField(db_column='ProspectAlternateKey', max_length=15, db_collation='SQL_Latin1_General_CP1_CI_AS', blank=True, null=True)  # Field name made lowercase.
    firstname = models.CharField(db_column='FirstName', max_length=50, db_collation='SQL_Latin1_General_CP1_CI_AS', blank=True, null=True)  # Field name made lowercase.
    middlename = models.CharField(db_column='MiddleName', max_length=50, db_collation='SQL_Latin1_General_CP1_CI_AS', blank=True, null=True)  # Field name made lowercase.
    lastname = models.CharField(db_column='LastName', max_length=50, db_collation='SQL_Latin1_General_CP1_CI_AS', blank=True, null=True)  # Field name made lowercase.
    ...
    totalchildren = models.SmallIntegerField(db_column='TotalChildren', blank=True, null=True)  # Field name made lowercase.
    numberchildrenathome = models.SmallIntegerField(db_column='NumberChildrenAtHome', blank=True, null=True)  # Field name made lowercase.
    education = models.CharField(db_column='Education', max_length=40, db_collation='SQL_Latin1_General_CP1_CI_AS', blank=True, null=True)  # Field name made lowercase.
    ...
    postalcode = models.CharField(db_column='PostalCode', max_length=15, db_collation='SQL_Latin1_General_CP1_CI_AS', blank=True, null=True)  # Field name made lowercase.
    phone = models.CharField(db_column='Phone', max_length=20, db_collation='SQL_Latin1_General_CP1_CI_AS', blank=True, null=True)  # Field name made lowercase.
    salutation = models.CharField(db_column='Salutation', max_length=8, db_collation='SQL_Latin1_General_CP1_CI_AS', blank=True, null=True)  # Field name made lowercase.
